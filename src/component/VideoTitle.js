  ...
  return (
    <div className='md:px-24 w-screen aspect-video pt-[20%] px-24 absolute text-white  bg-gradient-to-t from-black'>
      ...
      <div className='my-4 md:m-0'>
        <button className='bg-gray-600 rounded-lg hover:bg-opacity-30 bg-opacity-80 text-white p-3 px-8 text-xl md:py-3 md:px-11 hidden md:inline-block'>▶️Play</button>
